...
const useStyles = makeStyles((theme) => ({
  templateImg: {
    backgroundImage:
      "url(https://dl.airtable.com/exploreCoverImages%2FyjDjFdN1QmCwDroNx6Lh_exploreCoverImages%252FBXHWgDuWRCab0CShfeaQ_exploreCoverImages%252FyaahoGHTkiA4jLCBEc4Q_receipts.png)",
    height: "200px",
